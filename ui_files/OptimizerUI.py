...
class Ui_optimizer_ui(object):
    def setupUi(self, optimizer_ui):
        ...
        self.optimizer_type_selector.add_section_header("Recommended")
        ...
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"OCGOptV2", None))
        ...
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"AdaMuon_adv", None))
        ...
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"ADOPTScheduleFree", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"AdEMAMix", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"AdaBelief", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"AdaFactor", None))
        ...
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"AdamW_adv", None))
        ...
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"AINOOpt", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"AMUSE", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"BilatMuon", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"BilatMuonNS", None))
        ...
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"Dehaze", None))
        ...
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"FARMSCropV2", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"FCompass", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"FCompassADOPT", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"FCompassADOPTMARS", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"FCompassPlus", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"Fira", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"FMARSCrop", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"FMARSCropV2", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"FMARSCropV2ExMachina", None))
        ...
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"GrokFastAdamW", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"LPFAdamW", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"Lion", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"Lion_adv", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"MODA", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"MomentusCaution", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"Muon_adv", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"Mythical", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"NorMuonScheduleFree", None))
        ...
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"Prodigy_adv", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"ProdigyPlusScheduleFree", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"ProjectiveAdam", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"RAdamScheduleFree", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"REMASTER", None))
        ...
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"SignSGD_adv", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"SingState", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"SinkSGD_adv", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"SODA", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"SODAWrapper", None))
        ...
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"WarpAdam", None))
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"WarpAINO", None))
        ...
        self.loss_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"Huber", None))
