...
class Ui_network_ui(object):
    def setupUi(self, network_ui):
        ...
        self.algo_select.addItem("DyLoRA")
        self.algo_select.addItem("BOFT")
        self.algo_select.addItem("Diag-OFT")
        self.algo_select.addItem("Full")
        self.algo_select.addItem("GLoRA")
        self.algo_select.addItem("ABBA")
        self.algo_select.addItem("TLora")
        self.algo_select.addItem("GoRA")
        self.algo_select.addItem("RaLoRA")
        self.algo_select.addItem("LoRA2")
        self.algo_select.addItem("OrthoLoRA")
...
#if QT_CONFIG(tooltip)
        self.train_blocks_label.setToolTip(QCoreApplication.translate("network_ui", u"<html><head/><body><p>Select blocks to train, single blocks, double blocks, or all (both).</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.train_blocks_label.setText(QCoreApplication.translate("network_ui", u"Train Blocks (Flux only)", None))
...
#if QT_CONFIG(tooltip)
        self.ip_gamma_enable.setToolTip(QCoreApplication.translate("network_ui", u"<html><head/><body><p>IP Noise Gamma is a noise modification that adds additional noise, which can acclerate learning, but introduce incoherence if too high.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.ip_gamma_enable.setText(QCoreApplication.translate("network_ui", u"IP Noise Gamma", None))
#if QT_CONFIG(tooltip)
        self.ip_gamma_input.setToolTip(QCoreApplication.translate("network_ui", u"<html><head/><body><p>IP Noise Gamma is a noise modification that adds additional noise, which can acclerate learning, but introduce incoherence if too high.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
